...
let UsersController = class UsersController {
    ...
    async updateMe(dto, user) {
        return this.usersService.update(user.id, dto, user.companyId, user.id, user.role);
    }
    async findAll(user) {
        return this.usersService.findAll(user.companyId);
    }
    async invite(dto, user) {
        return this.usersService.invite(dto, user.companyId, user.role);
    }
    async findOne(id, user) {
        return this.usersService.findOne(id, user.companyId);
    }
    async update(id, dto, user) {
        return this.usersService.update(id, dto, user.companyId, user.id, user.role);
    }
    async remove(id, user) {
        return this.usersService.remove(id, user.companyId, user.id, user.role);
    }
};
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List all users in company' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Invite a new user to company' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'User invited successfully' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Only admins can invite users' }),
    (0, swagger_1.ApiResponse)({ status: 409, description: 'User already exists' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.InviteUserDto, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Only admins can delete users' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'User not found' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
