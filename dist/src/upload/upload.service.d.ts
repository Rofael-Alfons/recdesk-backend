...
export declare class UploadService {
    ...
    private uploadDir;
    constructor(prisma: PrismaService, fileProcessingService: FileProcessingService, aiService: AiService, configService: ConfigService, billingService: BillingService);
